...
text_from_file = read_text_from_file("task_5_input.txt")
list_compressed_text = compress_text(text_from_file) 
write_text_into_file("task_5_output.txt", list_compressed_text)
compressed_text = read_text_from_file('task_5_output.txt')
